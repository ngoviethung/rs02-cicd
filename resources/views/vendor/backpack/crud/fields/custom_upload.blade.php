...
@if ($crud->fieldTypeNotLoaded($field))
    ...
    @push('crud_fields_scripts')
        ...
        <script>
            ...
            document.getElementById('mp3').onchange = setFileInfo;
            ...
            function updateInfos() {
              ...
              for (var i = 0; i < myVideos.length; i++) {
                document.getElementById("duration").value = Math.floor(myVideos[i].duration);
                //infos.textContent += myVideos[i].name + " duration: " + Math.floor(myVideos[i].duration) + '\n';
              }
            }
        </script>
    @endpush
